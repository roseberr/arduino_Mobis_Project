...
int start=1, ir_val=1000;
int isLeftBlack=-1, isRightBlack=-1;
...
void loop() {
  ...
  xTaskCreate(Driving, "Driving", 100, NULL, NULL, NULL);

  xTaskCreate(Sensor, "Sensor", 100, NULL, NULL, NULL);
      
}


static void Driving(void* pvParameters){
  while(true){

    isLeftBlack = digitalRead(A0);    
    isRightBlack = digitalRead(A5);    
    ...
    // go forward
      ...
      // right_curve
      else if (isLeftBlack == 0 && isRightBlack == 1) {           
      ...
      // left_curve
      else if (isLeftBlack == 1 && isRightBlack== 0) {              
      ...
      //stop
      else if (isLeftBlack == 1 && isRightBlack == 1) {}        
